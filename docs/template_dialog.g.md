...
- [🏛️ Class `_FileDropWidget`](#%EF%B8%8F-class-_filedropwidget)
...
- [🏛️ Class `_FilesListWidget`](#%EF%B8%8F-class-_fileslistwidget)
...
- [🏛️ Class `_ImageDropWidget`](#%EF%B8%8F-class-_imagedropwidget)
...
- [🏛️ Class `_ImagesListWidget`](#%EF%B8%8F-class-_imageslistwidget)
