...
- [🏛️ Class `TemplateDialog`](#️-class-templatedialog)
  ...
  - [⚙️ Method `_apply_dates_from_image_paths`](#️-method-_apply_dates_from_image_paths)
  - [⚙️ Method `_apply_initial_geometry`](#️-method-_apply_initial_geometry)
  ...
  - [⚙️ Method `_finalize_date_edit`](#️-method-_finalize_date_edit)
  - [⚙️ Method `_get_widget_value`](#️-method-_get_widget_value)
  - [⚙️ Method `_is_date_field_empty`](#️-method-_is_date_field_empty)
  - [⚙️ Method `_load_entry_into_form`](#️-method-_load_entry_into_form)
  - [⚙️ Method `_lock_date_field`](#️-method-_lock_date_field)
  - [⚙️ Method `_on_cancel`](#️-method-_on_cancel)
  - [⚙️ Method `_on_date_field_edited`](#️-method-_on_date_field_edited)
  - [⚙️ Method `_on_entry_selection_changed`](#️-method-_on_entry_selection_changed)
  ...
  - [⚙️ Method `_refresh_image_filename_bases`](#️-method-_refresh_image_filename_bases)
  - [⚙️ Method `_reset_form_to_defaults`](#️-method-_reset_form_to_defaults)
  - [⚙️ Method `_set_date_edit_to_empty`](#️-method-_set_date_edit_to_empty)
  - [⚙️ Method `_set_date_on_widget`](#️-method-_set_date_on_widget)
  ...
  - [⚙️ Method `_update_image_save_dir`](#️-method-_update_image_save_dir)
  - [⚙️ Method `_uses_empty_date_sentinel`](#️-method-_uses_empty_date_sentinel)
  - [⚙️ Method `_wire_date_from_images`](#️-method-_wire_date_from_images)
  - [⚙️ Method `_wire_image_filename_rows`](#️-method-_wire_image_filename_rows)
...
### ⚙️ Method `_apply_dates_from_image_paths`
...
### ⚙️ Method `_apply_initial_geometry`
...
### ⚙️ Method `_load_entry_into_form`
...
### ⚙️ Method `_on_date_field_edited`
...
### ⚙️ Method `_on_entry_selection_changed`
...
### ⚙️ Method `_on_speech_multiline_clicked`
...
### ⚙️ Method `_refresh_image_filename_bases`
...
### ⚙️ Method `_reset_form_to_defaults`
...
### ⚙️ Method `_set_date_edit_to_empty`
...
### ⚙️ Method `_set_multiline_ai_buttons_enabled`

```python
def _set_multiline_ai_buttons_enabled(self, enabled: bool) -> None
```
...
### ⚙️ Method `_update_image_save_dir`
...
### ⚙️ Method `_uses_empty_date_sentinel`
...
### ⚙️ Method `_wire_date_from_images`
...
### ⚙️ Method `_wire_image_filename_rows`
