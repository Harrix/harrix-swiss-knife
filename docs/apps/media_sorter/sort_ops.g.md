...
- [🏛️ Class `BinConfig`](#%EF%B8%8F-class-binconfig)
- [🏛️ Class `SortResult`](#%EF%B8%8F-class-sortresult)
- [🔧 Function `assign_to_bin`](#-function-assign_to_bin)
- [🔧 Function `parse_bins_from_config`](#-function-parse_bins_from_config)
- [🔧 Function `resolve_working_path`](#-function-resolve_working_path)
- [🔧 Function `trash_file`](#-function-trash_file)
...
## 🔧 Function `assign_to_bin`

```python
def assign_to_bin(source: str | Path, bin_config: BinConfig, db: DatabaseManager) -> SortResult
```
...
## 🔧 Function `parse_bins_from_config`
