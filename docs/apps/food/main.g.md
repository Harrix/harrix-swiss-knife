...
- [🏛️ Class `MainWindow`](#️-class-mainwindow)
  ...
  - [⚙️ Method `on_add_as_text`](#️-method-on_add_as_text)
  - [⚙️ Method `on_add_food_item`](#️-method-on_add_food_item)
  - [⚙️ Method `on_add_food_log`](#️-method-on_add_food_log)
  - [⚙️ Method `on_check_problematic_records`](#️-method-on_check_problematic_records)
  - [⚙️ Method `on_clear_food_manual_name`](#️-method-on_clear_food_manual_name)
  - [⚙️ Method `on_favorite_food_item_selection_changed`](#️-method-on_favorite_food_item_selection_changed)
  - [⚙️ Method `on_food_add_with_ai`](#️-method-on_food_add_with_ai)
  - [⚙️ Method `on_food_item_double_clicked`](#️-method-on_food_item_double_clicked)
  - [⚙️ Method `on_food_log_table_cell_clicked`](#️-method-on_food_log_table_cell_clicked)
  - [⚙️ Method `on_food_stats_all_time`](#️-method-on_food_stats_all_time)
  - [⚙️ Method `on_food_stats_drink`](#️-method-on_food_stats_drink)
  - [⚙️ Method `on_food_stats_food_weight`](#️-method-on_food_stats_food_weight)
  - [⚙️ Method `on_food_stats_last_month`](#️-method-on_food_stats_last_month)
  - [⚙️ Method `on_food_stats_last_week`](#️-method-on_food_stats_last_week)
  - [⚙️ Method `on_food_stats_last_year`](#️-method-on_food_stats_last_year)
  - [⚙️ Method `on_food_stats_period_changed`](#️-method-on_food_stats_period_changed)
  - [⚙️ Method `on_food_stats_update`](#️-method-on_food_stats_update)
  - [⚙️ Method `on_kcal_with_ai`](#️-method-on_kcal_with_ai)
  - [⚙️ Method `on_main_food_item_selection_changed`](#️-method-on_main_food_item_selection_changed)
  - [⚙️ Method `on_portion_weight_with_ai_from_calories`](#️-method-on_portion_weight_with_ai_from_calories)
  - [⚙️ Method `on_show_all_records_clicked`](#️-method-on_show_all_records_clicked)
  - [⚙️ Method `on_translate_with_ai`](#️-method-on_translate_with_ai)
  - [⚙️ Method `resizeEvent`](#️-method-resizeevent)
  - [⚙️ Method `set_food_yesterday_date`](#️-method-set_food_yesterday_date)
  - [⚙️ Method `set_today_date`](#️-method-set_today_date)
  - [⚙️ Method `show_tables`](#️-method-show_tables)
  - [⚙️ Method `update_calories_calculation`](#️-method-update_calories_calculation)
  - [⚙️ Method `update_food_calories_today`](#️-method-update_food_calories_today)
  - [⚙️ Method `update_food_data`](#️-method-update_food_data)
  - [⚙️ Method `_add_food_item_from_log_record`](#️-method-_add_food_item_from_log_record)
  - [⚙️ Method `_add_one_day_to_food`](#️-method-_add_one_day_to_food)
  - [⚙️ Method `_adjust_food_log_table_columns`](#️-method-_adjust_food_log_table_columns)
  - [⚙️ Method `_adjust_kcal_per_day_table_columns`](#️-method-_adjust_kcal_per_day_table_columns)
  - [⚙️ Method `_append_food_log_rows_to_model`](#️-method-_append_food_log_rows_to_model)
  - [⚙️ Method `_apply_kcal_lookup_result`](#️-method-_apply_kcal_lookup_result)
  - [⚙️ Method `_commit_food_translate_translations`](#️-method-_commit_food_translate_translations)
  ...
  - [⚙️ Method `_correct_food_input_line`](#️-method-_correct_food_input_line)
  - [⚙️ Method `_create_colored_food_log_table_model`](#️-method-_create_colored_food_log_table_model)
  - [⚙️ Method `_create_colored_kcal_per_day_table_model`](#️-method-_create_colored_kcal_per_day_table_model)
  - [⚙️ Method `_create_dish_from_selected_ingredients`](#️-method-_create_dish_from_selected_ingredients)
  - [⚙️ Method `_create_table_model`](#️-method-_create_table_model)
  - [⚙️ Method `_delete_selected_food_log_rows`](#️-method-_delete_selected_food_log_rows)
  - [⚙️ Method `_dispose_models`](#️-method-_dispose_models)
  - [⚙️ Method `_filter_food_items`](#️-method-_filter_food_items)
  - [⚙️ Method `_finish_window_initialization`](#️-method-_finish_window_initialization)
  - [⚙️ Method `_food_log_translate_names_limit`](#️-method-_food_log_translate_names_limit)
  - [⚙️ Method `_get_current_selected_food_item`](#️-method-_get_current_selected_food_item)
  - [⚙️ Method `_init_database`](#️-method-_init_database)
  - [⚙️ Method `_init_favorite_food_items_list`](#️-method-_init_favorite_food_items_list)
  - [⚙️ Method `_init_food_items_list`](#️-method-_init_food_items_list)
  - [⚙️ Method `_init_food_log_table_delegates`](#️-method-_init_food_log_table_delegates)
  - [⚙️ Method `_init_food_stats_dates`](#️-method-_init_food_stats_dates)
  ...
  - [⚙️ Method `_on_food_name_text_edited`](#️-method-_on_food_name_text_edited)
  - [⚙️ Method `_on_tab_changed`](#️-method-_on_tab_changed)
  - [⚙️ Method `_open_text_input_dialog`](#️-method-_open_text_input_dialog)
  - [⚙️ Method `_populate_form_from_food_name`](#️-method-_populate_form_from_food_name)
  - [⚙️ Method `_process_food_item_selection`](#️-method-_process_food_item_selection)
  - [⚙️ Method `_process_text_input`](#️-method-_process_text_input)
  - [⚙️ Method `_reconnect_context_menu`](#️-method-_reconnect_context_menu)
  - [⚙️ Method `_report_food_translate_completion`](#️-method-_report_food_translate_completion)
  - [⚙️ Method `_reset_food_log_pagination_state`](#️-method-_reset_food_log_pagination_state)
  - [⚙️ Method `_set_today_date_in_food`](#️-method-_set_today_date_in_food)
  - [⚙️ Method `_setup_autocomplete`](#️-method-_setup_autocomplete)
  - [⚙️ Method `_setup_compact_menu_bar`](#️-method-_setup_compact_menu_bar)
  - [⚙️ Method `_setup_ui`](#️-method-_setup_ui)
  - [⚙️ Method `_show_all_food_items`](#️-method-_show_all_food_items)
  - [⚙️ Method `_show_food_log_context_menu`](#️-method-_show_food_log_context_menu)
  - [⚙️ Method `_show_food_translate_preview`](#️-method-_show_food_translate_preview)
  - [⚙️ Method `_show_food_yesterday_context_menu`](#️-method-_show_food_yesterday_context_menu)
  - [⚙️ Method `_show_kcal_with_ai_context_menu`](#️-method-_show_kcal_with_ai_context_menu)
  - [⚙️ Method `_show_use_calories_context_menu`](#️-method-_show_use_calories_context_menu)
  - [⚙️ Method `_start_bothub_worker`](#️-method-_start_bothub_worker)
  - [⚙️ Method `_subtract_one_day_from_food`](#️-method-_subtract_one_day_from_food)
  - [⚙️ Method `_swap_weight_and_calories_per_100g`](#️-method-_swap_weight_and_calories_per_100g)
  - [⚙️ Method `_transform_food_log_data`](#️-method-_transform_food_log_data)
  - [⚙️ Method `_update_add_button_appearance`](#️-method-_update_add_button_appearance)
  - [⚙️ Method `_update_autocomplete_data`](#️-method-_update_autocomplete_data)
  - [⚙️ Method `_update_drinks_chart`](#️-method-_update_drinks_chart)
  - [⚙️ Method `_update_favorite_food_items_list`](#️-method-_update_favorite_food_items_list)
  - [⚙️ Method `_update_food_calories_chart`](#️-method-_update_food_calories_chart)
  - [⚙️ Method `_update_food_items_list`](#️-method-_update_food_items_list)
  - [⚙️ Method `_update_food_log_table`](#️-method-_update_food_log_table)
  - [⚙️ Method `_update_food_log_table_with_data`](#️-method-_update_food_log_table_with_data)
  - [⚙️ Method `_update_food_weight_chart`](#️-method-_update_food_weight_chart)
  - [⚙️ Method `_update_kcal_per_day_table`](#️-method-_update_kcal_per_day_table)
...
### ⚙️ Method `_append_food_log_rows_to_model`
...
```python
def _create_colored_food_log_table_model(self, data: list[list], headers: list[str], _id_column: int = 9) -> QSortFilterProxyModel
```
...
### ⚙️ Method `_init_food_log_table_delegates`
...
### ⚙️ Method `_load_food_log_page`

```python
def _load_food_log_page(self) -> None
```
...
### ⚙️ Method `_on_food_name_text_edited`
...
### ⚙️ Method `_reconnect_context_menu`
...
### ⚙️ Method `_reset_food_log_pagination_state`
...
### ⚙️ Method `_subtract_one_day_from_food`
...
### ⚙️ Method `_swap_weight_and_calories_per_100g`
...
### ⚙️ Method `_transform_food_log_data`

```python
def _transform_food_log_data(self, rows: list[list]) -> list[list]
```
