...
```python
def build_transfer_item_from_log_row(*, date: str, name: str, name_en: str | None, weight: float | None, calories_per_100g: float | None, portion_calories: float | None, is_drink: bool) -> FoodLogTransferItem | None
```
