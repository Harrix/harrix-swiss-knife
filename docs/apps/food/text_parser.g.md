...
- [🏛️ Class `TextParser`](#️-class-textparser)
  ...
  - [⚙️ Method `_capitalize_name`](#️-method-_capitalize_name)
  - [⚙️ Method `_determine_parsing_strategy`](#️-method-_determine_parsing_strategy)
  - [⚙️ Method `_get_calories_from_database`](#️-method-_get_calories_from_database)
  - [⚙️ Method `_get_weight_and_calories_from_database`](#️-method-_get_weight_and_calories_from_database)
  - [⚙️ Method `_handle_unparseable_line`](#️-method-_handle_unparseable_line)
  - [⚙️ Method `_is_drink`](#️-method-_is_drink)
  - [⚙️ Method `_is_number`](#️-method-_is_number)
  - [⚙️ Method `_parse_line`](#️-method-_parse_line)
  - [⚙️ Method `_parse_name_only`](#️-method-_parse_name_only)
  - [⚙️ Method `_parse_name_with_one_number`](#️-method-_parse_name_with_one_number)
  - [⚙️ Method `_parse_name_with_portion`](#️-method-_parse_name_with_portion)
  - [⚙️ Method `_parse_name_with_two_numbers`](#️-method-_parse_name_with_two_numbers)
  - [⚙️ Method `_parse_name_with_two_numbers_and_portion`](#️-method-_parse_name_with_two_numbers_and_portion)
  - [⚙️ Method `_parse_tsv_line`](#️-method-_parse_tsv_line)
...
```python
def _determine_parsing_strategy(self, parts: list[str], numbers: list[tuple[int, float]], non_numbers: list[tuple[int, str]], food_date: str, db_manager: Any | None) -> ParsedFoodItem | None
```
...
```python
def _handle_unparseable_line(self, parts: list[str], food_date: str, db_manager: Any | None) -> ParsedFoodItem | None
```
...
```python
def _parse_line(self, line: str, default_date: str, db_manager: Any | None) -> ParsedFoodItem | None
```
