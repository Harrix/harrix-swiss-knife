...
# 📄 File `workout_preview_dialog.py`
...
- [🏛️ Class `WorkoutPreviewDialog`](#%EF%B8%8F-class-workoutpreviewdialog)
  - [⚙️ Method `__init__`](#%EF%B8%8F-method-__init__)
  - [⚙️ Method `rows`](#%EF%B8%8F-method-rows)
  - [⚙️ Method `title_text`](#%EF%B8%8F-method-title_text)

</details>

## 🏛️ Class `WorkoutPreviewDialog`
...
```python
def __init__(self, title: str, rows: list[ParsedSetRow], parent: QWidget | None = None) -> None
```

Show [`rows`](#%EF%B8%8F-method-rows) in a table the user can edit before Save.
