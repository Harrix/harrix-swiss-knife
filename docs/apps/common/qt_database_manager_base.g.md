...
- [🏛️ Class `DatabaseConnectionUnavailableError`](#️-class-databaseconnectionunavailableerror)
  - [⚙️ Method `__init__`](#️-method-__init__)
- [🏛️ Class `QtSqliteDatabaseManagerBase`](#️-class-qtsqlitedatabasemanagerbase)
  - [⚙️ Method `__init__`](#️-method-__init__-1)
  - [⚙️ Method `close`](#️-method-close)
  - [⚙️ Method `create_database_from_sql`](#️-method-create_database_from_sql)
  - [⚙️ Method `execute_query`](#️-method-execute_query)
  - [⚙️ Method `execute_simple_query`](#️-method-execute_simple_query)
  - [⚙️ Method `get_earliest_date`](#️-method-get_earliest_date)
  - [⚙️ Method `get_id`](#️-method-get_id)
  - [⚙️ Method `get_items`](#️-method-get_items)
  - [⚙️ Method `get_rows`](#️-method-get_rows)
  - [⚙️ Method `is_database_open`](#️-method-is_database_open)
  - [⚙️ Method `resolve_db_path_with_fallback`](#️-method-resolve_db_path_with_fallback)
