...
- [🏛️ Class `ImagePicker`](#%EF%B8%8F-class-imagepicker)
  ...
  - [⚙️ Method `set_on_paths_added`](#%EF%B8%8F-method-set_on_paths_added)
  - [⚙️ Method `set_save_dir`](#%EF%B8%8F-method-set_save_dir)
    ...
    def _refresh_single_removal_ui(self) -> None:
        ...
        if self._single_marked_for_removal and self.image_path:
            ...
            if self._clear_button is not None:
                ...
                apply_lucide_button_icon(self._clear_button, CLEAR_BUTTON_ICON)
...
### ⚙️ Method `get_images_bytes_and_mime`
...
### ⚙️ Method `get_pending_removed_paths`
