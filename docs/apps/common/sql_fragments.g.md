...
- [🏛️ Class `BaseSqlFragmentValidationError`](#️-class-basesqlfragmentvalidationerror)
- [🏛️ Class `EmptyOrderByFragmentError`](#️-class-emptyorderbyfragmenterror)
  - [⚙️ Method `__init__`](#️-method-__init__)
- [🏛️ Class `EmptySqlFragmentError`](#️-class-emptysqlfragmenterror)
  - [⚙️ Method `__init__`](#️-method-__init__-1)
- [🏛️ Class `UnsafeOrderByFragmentError`](#️-class-unsafeorderbyfragmenterror)
  - [⚙️ Method `__init__`](#️-method-__init__-2)
  - [⚙️ Method `invalid_direction`](#️-method-invalid_direction)
  - [⚙️ Method `too_complex`](#️-method-too_complex)
- [🏛️ Class `UnsafeSqlFragmentError`](#️-class-unsafesqlfragmenterror)
  - [⚙️ Method `__init__`](#️-method-__init__-3)
  - [⚙️ Method `forbidden_characters`](#️-method-forbidden_characters)
  - [⚙️ Method `forbidden_keyword`](#️-method-forbidden_keyword)
  - [⚙️ Method `no_tokens`](#️-method-no_tokens)
