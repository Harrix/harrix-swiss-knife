...
- [🔧 Function `config_key_belongs_to_app`](#-function-config_key_belongs_to_app)
- [🔧 Function `filter_config_categories`](#-function-filter_config_categories)
...
```python
def __init__(self, parent: QWidget | None = None, *, app_id: str | None = None, window_title: str | None = None) -> None
```
...
## 🔧 Function `config_key_belongs_to_app`
...
## 🔧 Function `filter_config_categories`
...
## 🔧 Function `merge_filtered_config`
...
## 🔧 Function `nested_setting_belongs_to_app`
