...
- [🏛️ Class `MainWindow`](#%EF%B8%8F-class-mainwindow)
  ...
  - [⚙️ Method `on_categories`](#%EF%B8%8F-method-on_categories)
  ...
  - [⚙️ Method `on_currencies`](#%EF%B8%8F-method-on_currencies)
  - [⚙️ Method `on_delete_account`](#%EF%B8%8F-method-on_delete_account)
  - [⚙️ Method `on_delete_exchange`](#%EF%B8%8F-method-on_delete_exchange)
...
```python
class MainWindow(QMainWindow, window.Ui_MainWindow, AppWindowMixin, TableOperations, DateOperations, ChartOperations, AutoSaveOperations, ValidationOperations, ExchangeRatesOperations, ReportOperations)
```
...
class MainWindow(
    ...
    def _connect_signals(self) -> None:
        ...
        self._ai_image_drop_zone = ImagePicker(
            ...
            on_double_click=self.pushButton_add_as_text_with_ai.click,
    ...
    def _show_amount_context_menu(self, position: QPoint) -> None:
        ...
        context_menu.exec_(self.doubleSpinBox_amount.mapToGlobal(position))
