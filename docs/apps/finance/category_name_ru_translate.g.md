...
# 📄 File `category_name_ru_translate.py`
...
- [🔧 Function `parse_category_name_ru_response`](#-function-parse_category_name_ru_response)
- [🔧 Function `request_category_name_ru_translation`](#-function-request_category_name_ru_translation)

</details>

## 🔧 Function `parse_category_name_ru_response`
...
## 🔧 Function `request_category_name_ru_translation`

```python
def request_category_name_ru_translation(parent: QWidget) -> None
```
