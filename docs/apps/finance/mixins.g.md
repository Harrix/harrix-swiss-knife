...
- [🏛️ Class `AutoSaveOperations`](#️-class-autosaveoperations)
  ...
  - [⚙️ Method `_save_account_data`](#️-method-_save_account_data)
  - [⚙️ Method `_save_category_data`](#️-method-_save_category_data)
  - [⚙️ Method `_save_currency_data`](#️-method-_save_currency_data)
  - [⚙️ Method `_save_exchange_data`](#️-method-_save_exchange_data)
  - [⚙️ Method `_save_rate_data`](#️-method-_save_rate_data)
  - [⚙️ Method `_save_transaction_data`](#️-method-_save_transaction_data)
  - [⚙️ Method `_show_auto_save_error`](#️-method-_show_auto_save_error)
- [🏛️ Class `ChartOperations`](#️-class-chartoperations)
  - [⚙️ Method `_add_finance_chart_stats_box`](#️-method-_add_finance_chart_stats_box)
  - [⚙️ Method `_add_finance_expense_income_stats_box`](#️-method-_add_finance_expense_income_stats_box)
  - [⚙️ Method `_annotate_balance_chart_extrema`](#️-method-_annotate_balance_chart_extrema)
  - [⚙️ Method `_annotate_chart_last_point`](#️-method-_annotate_chart_last_point)
  - [⚙️ Method `_annotate_compare_flow_chart_extrema`](#️-method-_annotate_compare_flow_chart_extrema)
  - [⚙️ Method `_annotate_datetime_line_last_point`](#️-method-_annotate_datetime_line_last_point)
  - [⚙️ Method `_chart_labels_enabled`](#️-method-_chart_labels_enabled)
  - [⚙️ Method `_format_chart_last_point_value`](#️-method-_format_chart_last_point_value)
  - [⚙️ Method `_format_chart_period_date`](#️-method-_format_chart_period_date)
  - [⚙️ Method `_format_chart_point_label`](#️-method-_format_chart_point_label)
  - [⚙️ Method `_sparse_integer_ticks`](#️-method-_sparse_integer_ticks)
- [🏛️ Class `DateOperations`](#️-class-dateoperations)
- [🏛️ Class `ValidationOperations`](#️-class-validationoperations)
  - [⚙️ Method `_show_db_error`](#️-method-_show_db_error)
  - [⚙️ Method `_show_error`](#️-method-_show_error)
  - [⚙️ Method `_show_validation_error`](#️-method-_show_validation_error)
...
class ChartOperations(ChartOperationsBase):
    ...
    def _annotate_balance_chart_extrema(
        ...
        *,
        ...
        """Label global and local extrema on the balance chart."""
        if not series:
            return
        ...
        def label_for_index(index: int) -> str:
            ...
            return self._format_chart_point_label(date_str, value, period, currency_symbol)
...
### ⚙️ Method `_annotate_compare_flow_chart_extrema`

```python
def _annotate_compare_flow_chart_extrema(self, ax: Axes, series: list[tuple[int, float, str]], fig: Figure) -> None
```
