...
- [🏛️ Class `FinanceDashboardWidget`](#%EF%B8%8F-class-financedashboardwidget)
  - [⚙️ Method `__init__`](#%EF%B8%8F-method-__init__)
  - [⚙️ Method `set_today_expense`](#%EF%B8%8F-method-set_today_expense)
- [🔧 Function `pick_today_expense_display`](#-function-pick_today_expense_display)

</details>

## 🏛️ Class `FinanceDashboardWidget`
...
## 🔧 Function `pick_today_expense_display`

```python
def pick_today_expense_display(lines: list[str], *, default_code: str, zero_text: str) -> tuple[str, str]
```
