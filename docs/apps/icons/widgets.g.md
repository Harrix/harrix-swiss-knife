...
- [🏛️ Class `DraggableIconList`](#%EF%B8%8F-class-draggableiconlist)
  ...
  - [⚙️ Method `selected_copy_entries`](#%EF%B8%8F-method-selected_copy_entries)
...
- [🔧 Function `stage_clipboard_icon_file`](#-function-stage_clipboard_icon_file)
...
```python
def __init__(self, parent: QWidget | None = None, *, icon_size: int = DEFAULT_THUMB_SIZE, emit_family_selection: bool = True, dual_line_labels: bool = False, variants_context: bool = False) -> None
```
...
### ⚙️ Method `selected_copy_entries`
...
## 🔧 Function `stage_clipboard_icon_file`
