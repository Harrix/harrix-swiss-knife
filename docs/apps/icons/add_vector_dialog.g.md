...
- [🏛️ Class `AddVectorImageDialog`](#%EF%B8%8F-class-addvectorimagedialog)
  - [⚙️ Method `__init__`](#%EF%B8%8F-method-__init__)
  - [⚙️ Method `get_meta`](#%EF%B8%8F-method-get_meta)

</details>

## 🏛️ Class `AddVectorImageDialog`
...
```python
def __init__(self, parent: QWidget | None, *, source_path: Path, defaults: RepoMetaDefaults, app_config: dict[str, Any], initial_meta: NoteMeta | None = None, window_title: str | None = None) -> None
```
