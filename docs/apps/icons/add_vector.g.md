...
- [🔧 Function `merge_note_families`](#-function-merge_note_families)
- [🔧 Function `merge_variant_dest_name`](#-function-merge_variant_dest_name)
...
## 🔧 Function `merge_note_families`

```python
def merge_note_families(repo_root: Path, *, source_family_ids: Sequence[str], target_family_id: str, rebuild: bool = True) -> AddVectorReport
```
...
## 🔧 Function `merge_variant_dest_name`
