...
- [🏛️ Class `DatabaseManager`](#️-class-databasemanager)
  ...
  - [⚙️ Method `add_habit`](#️-method-add_habit)
  - [⚙️ Method `add_process_habit_record`](#️-method-add_process_habit_record)
  - [⚙️ Method `delete_habit`](#️-method-delete_habit)
  - [⚙️ Method `delete_process_habit_record`](#️-method-delete_process_habit_record)
  - [⚙️ Method `ensure_habits_schema`](#️-method-ensure_habits_schema)
  - [⚙️ Method `get_all_habits`](#️-method-get_all_habits)
  - [⚙️ Method `get_all_process_habits_records`](#️-method-get_all_process_habits_records)
  - [⚙️ Method `get_earliest_process_habit_date`](#️-method-get_earliest_process_habit_date)
  - [⚙️ Method `get_filtered_process_habits_records`](#️-method-get_filtered_process_habits_records)
  - [⚙️ Method `get_habit_calendar_data`](#️-method-get_habit_calendar_data)
  - [⚙️ Method `get_habits`](#️-method-get_habits)
  - [⚙️ Method `get_habits_years`](#️-method-get_habits_years)
  - [⚙️ Method `get_limited_process_habits_records`](#️-method-get_limited_process_habits_records)
  - [⚙️ Method `set_habit_archived`](#️-method-set_habit_archived)
  - [⚙️ Method `update_habit`](#️-method-update_habit)
  - [⚙️ Method `update_process_habit_record`](#️-method-update_process_habit_record)
