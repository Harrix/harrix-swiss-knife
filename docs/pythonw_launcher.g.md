...
- [🏛️ Class `FixPythonwResult`](#️-class-fixpythonwresult)
...
## 🏛️ Class `FixPythonwResult`

```python
class FixPythonwResult
```

Outcome of attempting to repair `.venv\Scripts\pythonw.exe`.
