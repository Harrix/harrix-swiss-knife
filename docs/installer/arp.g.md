...
- [🔧 Function `register_uninstall`](#-function-register_uninstall)
- [🔧 Function `unregister_uninstall`](#-function-unregister_uninstall)
...
```python
def register_uninstall(*, install_root: Path, hsk_path: Path, version: str, publisher: str = 'Harrix', display_name: str = 'Harrix Swiss Knife', log: OutcomeLog | None = None) -> bool
```
