...
- [🏛️ Class `MediaSorterBin`](#%EF%B8%8F-class-mediasorterbin)
- [🏛️ Class `MediaSorterSettings`](#%EF%B8%8F-class-mediasortersettings)
...
```python
class BothubSettings(TypedDict)
```
...
```python
class FoodCalorieThresholds(TypedDict)
```
...
## 🏛️ Class `MediaSorterBin`

```python
class MediaSorterBin(TypedDict)
```
...
## 🏛️ Class `MediaSorterSettings`

```python
class MediaSorterSettings(TypedDict)
```
