...
- [🏛️ Class `TemplateParser`](#%EF%B8%8F-class-templateparser)
  - [⚙️ Method `append_address_suffix_to_title (staticmethod)`](#%EF%B8%8F-method-append_address_suffix_to_title-staticmethod)
  ...
  - [⚙️ Method `shorten_address_for_title (staticmethod)`](#%EF%B8%8F-method-shorten_address_for_title-staticmethod)
...
`@append_to_note_name` on [`line`](installer/log.g.md#%EF%B8%8F-method-line) shows a dialog button that appends a shortened address
...
### ⚙️ Method `append_address_suffix_to_title (staticmethod)`
...
### ⚙️ Method `shorten_address_for_title (staticmethod)`
