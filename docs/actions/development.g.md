...
- [🔧 Function `_download_to_path`](#-function-_download_to_path)
- [🔧 Function `_extract_exe_from_zip`](#-function-_extract_exe_from_zip)
- [🔧 Function `_fetch_release_latest`](#-function-_fetch_release_latest)
- [🔧 Function `_get_asset_download_url`](#-function-_get_asset_download_url)
- [🔧 Function `_github_api_headers`](#-function-_github_api_headers)
...
## 🔧 Function `_extract_exe_from_zip`

```python
def _extract_exe_from_zip(zip_path: Path, dest_dir: Path, exe_name: str, archive_inner_path: str | None = None) -> Path | None
```
...
## 🔧 Function `_fetch_release_latest`
...
## 🔧 Function `_get_asset_download_url`

```python
def _get_asset_download_url(release: dict[str, Any], asset_name: str | None = None, name_contains: tuple[str, ...] = ()) -> str
```
