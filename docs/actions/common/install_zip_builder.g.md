...
- [🔧 Function `default_tray_step_labels`](#-function-default_tray_step_labels)
...
- [🔧 Function `populate_uv_cache`](#-function-populate_uv_cache)
- [🔧 Function `redundant_media_zip_names`](#-function-redundant_media_zip_names)
...
Selected builder steps (order is fixed by [`run_pipeline`](#-function-run_pipeline)).
...
### ⚙️ Method `from_labels (classmethod)`
...
## 🏛️ Class `PipelineResult`

```python
class PipelineResult
```

Outcome of [`run_pipeline`](#-function-run_pipeline).
...
## 🔧 Function `asset_download_url`

```python
def asset_download_url(release: dict[str, Any], *, asset_name: str | None = None, name_contains: Sequence[str] = ()) -> str
```
...
## 🔧 Function `default_tray_step_labels`
...
```python
def download_url(url: str, dest: Path, *, config: dict[str, Any] | None = None, project_root: Path | None = None, force: bool = True) -> bool
```
...
## 🔧 Function `fetch_github_release_latest`

```python
def fetch_github_release_latest(owner: str, repo: str, *, config: dict[str, Any] | None = None, project_root: Path | None = None) -> dict[str, Any]
```
...
## 🔧 Function `populate_binaries`

```python
def populate_binaries(project_root: Path, log: LogFn, *, config: dict[str, Any] | None = None, force: bool = True) -> None
```
...
## 🔧 Function `populate_installers`

```python
def populate_installers(project_root: Path, log: LogFn, *, config: dict[str, Any] | None = None, force: bool = True) -> None
```
...
## 🔧 Function `redundant_media_zip_names`
