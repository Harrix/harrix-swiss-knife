...
- [🏛️ Class `OnUpdateHarrixSwissKnife`](#️-class-onupdateharrixswissknife)
  ...
  - [⚙️ Method `_download_https_to_path`](#️-method-_download_https_to_path)
  - [⚙️ Method `_fetch_github_default_branch`](#️-method-_fetch_github_default_branch)
  - [⚙️ Method `_git_porcelain`](#️-method-_git_porcelain)
  - [⚙️ Method `_git_run`](#️-method-_git_run)
  - [⚙️ Method `_load_json_dict`](#️-method-_load_json_dict)
  - [⚙️ Method `_restore_config_dir_except_json`](#️-method-_restore_config_dir_except_json)
  - [⚙️ Method `_top_level_keys_differing`](#️-method-_top_level_keys_differing)
  - [⚙️ Method `_worker_finished`](#️-method-_worker_finished)
  - [⚙️ Method `_worker_git_pull`](#️-method-_worker_git_pull)
  - [⚙️ Method `_worker_run`](#️-method-_worker_run)
  - [⚙️ Method `_worker_zip_swiss_knife`](#️-method-_worker_zip_swiss_knife)
  - [⚙️ Method `_worker_zip_update`](#️-method-_worker_zip_update)
  - [⚙️ Method `_write_config_json_pretty`](#️-method-_write_config_json_pretty)
