...
- [🏛️ Class `OnDiscardGitChanges`](#%EF%B8%8F-class-ondiscardgitchanges)
  ...
  - [⚙️ Method `find_git_repos (staticmethod)`](#%EF%B8%8F-method-find_git_repos-staticmethod)
  - [⚙️ Method `git_porcelain (staticmethod)`](#%EF%B8%8F-method-git_porcelain-staticmethod)
  - [⚙️ Method `git_run (staticmethod)`](#%EF%B8%8F-method-git_run-staticmethod)
  - [⚙️ Method `in_thread`](#%EF%B8%8F-method-in_thread)
  - [⚙️ Method `is_git_repo (staticmethod)`](#%EF%B8%8F-method-is_git_repo-staticmethod)
...
### ⚙️ Method `find_git_repos (staticmethod)`
...
### ⚙️ Method `git_porcelain (staticmethod)`
...
### ⚙️ Method `is_git_repo (staticmethod)`
