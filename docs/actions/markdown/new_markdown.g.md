...
- [🏛️ Class `OnNewMarkdown`](#%EF%B8%8F-class-onnewmarkdown)
  - [⚙️ Method `apply_personal_data_to_beginning (staticmethod)`](#%EF%B8%8F-method-apply_personal_data_to_beginning-staticmethod)
  - [⚙️ Method `build_picker_choices`](#%EF%B8%8F-method-build_picker_choices)
  - [⚙️ Method `empty_jupyter_notebook (staticmethod)`](#%EF%B8%8F-method-empty_jupyter_notebook-staticmethod)
...
class OnNewMarkdown(ActionBase):
    ...
    def _commit_template_entry_edit(
        ...
        *,
        ...
        if selected_entry.kind == "city_note":
            ...
            self._open_notes_editor(target_md)
        ...
        self._open_notes_editor(target_path)
    ...
    def _open_notes_editor(self, file_path: str | Path, *, workspace_key: str = "vscode_workspace_notes") -> None:
        """Open a file in the configured notes editor without shell interpolation."""
        open_in_editor(
            str(self.config["editor-notes"]),
    ...
    def _save_new_city_note(
        ...
        *,
        ...
        self._open_notes_editor(created_path)
        self.add_line(msg)
...
### ⚙️ Method `apply_personal_data_to_beginning (staticmethod)`
...
### ⚙️ Method `empty_jupyter_notebook (staticmethod)`
