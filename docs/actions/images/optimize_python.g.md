...
- [🏛️ Class `OnOptimizePython`](#%EF%B8%8F-class-onoptimizepython)
  - [⚙️ Method `in_thread`](#%EF%B8%8F-method-in_thread)
  - [⚙️ Method `optimize_images_python`](#%EF%B8%8F-method-optimize_images_python)

</details>

## 🏛️ Class `OnOptimizePython`
...
### ⚙️ Method `optimize_images_python`
