...
- [🏛️ Class `OnSyncSaveCommands`](#%EF%B8%8F-class-onsyncsavecommands)
  - [⚙️ Method `execute`](#%EF%B8%8F-method-execute)

</details>

## 🏛️ Class `OnSyncSaveCommands`
...
```python
def execute(self, *_args: Any, editors: tuple[str, ...] | list[str] | None = None, force: bool = False, noninteractive: bool = False, **_kwargs: Any) -> None
```
