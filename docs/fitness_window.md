...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.listView_exercises.setMinimumSize(QSize(200, 0))
        self.listView_exercises.setMaximumSize(QSize(250, 16777215))
