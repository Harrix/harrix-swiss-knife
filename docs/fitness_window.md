...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.listView_exercises = QListView(self.tab)
        self.listView_exercises.setObjectName("listView_exercises")
        self.listView_exercises.setMaximumSize(QSize(301, 16777215))

        self.horizontalLayout_2.addWidget(self.listView_exercises)
        ...
        self.label_exercise_avif.setGeometry(QRect(10, 560, 281, 150))
        ...
        self.scrollAreaWidgetContents_charts.setGeometry(QRect(0, 0, 1147, 731))
        ...
        self.scrollAreaWidgetContents_weight_chart.setGeometry(QRect(0, 0, 1147, 764))
