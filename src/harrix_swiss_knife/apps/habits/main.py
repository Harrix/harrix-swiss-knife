...
PROCESS_HABIT_VALUE_COLUMN_MIN_WIDTH = 86
HEATMAP_WEEK_STARTS_ON = 6  # Sunday, same as dayplot default
HEATMAP_MONTH_GAP = 0.7
HEATMAP_CELL_INSET = 0.35
HEATMAP_MONTH_LABEL_X_INSET = 0.1
HEATMAP_MONTH_LABEL_Y_MIN = 6.5
