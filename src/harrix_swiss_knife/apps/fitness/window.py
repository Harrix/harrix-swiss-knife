...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionAdd_Exercise.setText(QCoreApplication.translate("MainWindow", u"\u2795 Add Exercise", None))
        self.actionRefresh_Exercises_Table.setText(QCoreApplication.translate("MainWindow", u"\U0001f504 Refresh Exercises Table", None))
        self.actionAdd_Exercise_Type.setText(QCoreApplication.translate("MainWindow", u"\u2795 Add Exercise Type", None))
        self.actionRefresh_Types_Table.setText(QCoreApplication.translate("MainWindow", u"\U0001f504 Refresh Types Table", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_fitness_dashboard), QCoreApplication.translate("MainWindow", u"Quick", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_workouts), QCoreApplication.translate("MainWindow", u"Workouts", None))
    ...
    def setupUi(self, MainWindow):
        ...
        self.actionAdd_Exercise = QAction(MainWindow)
        self.actionAdd_Exercise.setObjectName(u"actionAdd_Exercise")
        self.actionRefresh_Exercises_Table = QAction(MainWindow)
        self.actionRefresh_Exercises_Table.setObjectName(u"actionRefresh_Exercises_Table")
        self.actionAdd_Exercise_Type = QAction(MainWindow)
        self.actionAdd_Exercise_Type.setObjectName(u"actionAdd_Exercise_Type")
        self.actionRefresh_Types_Table = QAction(MainWindow)
        self.actionRefresh_Types_Table.setObjectName(u"actionRefresh_Types_Table")
        ...
        self.tab_fitness_dashboard = QWidget()
        self.tab_fitness_dashboard.setObjectName(u"tab_fitness_dashboard")
        self.verticalLayout_fitness_dashboard = QVBoxLayout(self.tab_fitness_dashboard)
        self.verticalLayout_fitness_dashboard.setObjectName(u"verticalLayout_fitness_dashboard")
        self.tabWidget.addTab(self.tab_fitness_dashboard, "")
        self.tab = QWidget()
...
"                                      }")
        ...
        self.pushButton_select_exercise.setObjectName(u"pushButton_select_exercise")
...
"                                }")
        ...
        self.widget_process = QWidget(self.splitter)
        self.widget_process.setObjectName(u"widget_process")
        self.verticalLayout_process = QVBoxLayout(self.widget_process)
        self.verticalLayout_process.setSpacing(4)
        self.verticalLayout_process.setObjectName(u"verticalLayout_process")
        self.verticalLayout_process.setContentsMargins(0, 0, 0, 0)
        self.groupBox_filter = QGroupBox(self.widget_process)
        ...
        self.horizontalLayout_filter.addWidget(self.label_filter_exercise)
        ...
        sizePolicy.setHeightForWidth(self.comboBox_filter_exercise.sizePolicy().hasHeightForWidth())
        self.comboBox_filter_exercise.setSizePolicy(sizePolicy)
        self.comboBox_filter_exercise.setMinimumSize(QSize(100, 0))

        self.horizontalLayout_filter.addWidget(self.comboBox_filter_exercise)
        ...
        self.tableView_process = QTableView(self.widget_process)
        self.tableView_process.setObjectName(u"tableView_process")

        self.verticalLayout_process.addWidget(self.tableView_process)

        self.splitter.addWidget(self.widget_process)

        self.horizontalLayout_main.addWidget(self.splitter)

        self.tabWidget.addTab(self.tab, "")
        self.tab_workouts = QWidget()
        self.tab_workouts.setObjectName(u"tab_workouts")
        self.verticalLayout_workouts = QVBoxLayout(self.tab_workouts)
        self.verticalLayout_workouts.setObjectName(u"verticalLayout_workouts")
        self.tabWidget.addTab(self.tab_workouts, "")
...
"                                }")
        ...
        self.label_chart_info.setObjectName(u"label_chart_info")
        ...
        self.scrollAreaWidgetContents_charts.setGeometry(QRect(0, 0, 1036, 422))
        ...
        self.dateEdit_weight.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.scrollAreaWidgetContents_weight_chart.setGeometry(QRect(0, 0, 1088, 482))
        ...
        self.pushButton_exercise_goal_recommendations.setObjectName(u"pushButton_exercise_goal_recommendations")
        ...
        self.menuCommanda.addSeparator()
        self.menuCommanda.addAction(self.actionAdd_Exercise)
        self.menuCommanda.addAction(self.actionRefresh_Exercises_Table)
        self.menuCommanda.addSeparator()
        self.menuCommanda.addAction(self.actionAdd_Exercise_Type)
        self.menuCommanda.addAction(self.actionRefresh_Types_Table)
