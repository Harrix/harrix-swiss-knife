...
_ROW_COLOR_CURRENT = QColor(255, 236, 179)  # Amber highlight for the active exercise
_COL_TYPE_WIDTH = 140
_COL_VALUE_WIDTH = 90
_COL_UNIT_WIDTH = 90
_GREEN_BUTTON_STYLE = """
...
class WorkoutsWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        standard_bold_font = QFont()
        standard_bold_font.setBold(True)
        title_font = QFont()
        title_font.setBold(True)
        primary_timer_font = QFont()
        primary_timer_font.setPointSize(16)
        primary_timer_font.setBold(True)
        secondary_timer_font = QFont()
        secondary_timer_font.setPointSize(12)
        secondary_timer_font.setBold(True)
        ...
        self.label_session_timer.setFont(primary_timer_font)
        ...
        self.label_exercise_timer.setFont(secondary_timer_font)
