"""Shared Qt mixin classes used by all tracker applications.

These mixins centralize common functionality that was previously duplicated in
`finance/mixins.py`, `fitness/mixins.py`, `food/mixins.py`, and
`habits/mixins.py`:
