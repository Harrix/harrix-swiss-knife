...
from harrix_swiss_knife.qt_lucide_icon import style_accept_button, style_delete_button
...
def prepare_box(box: QMessageBox) -> None:
    """Ensure `box` has a Copy button and green accept / red delete chrome."""
