...
_DEFAULT_COMPACT_HINT = "Drag and drop images here, paste (Ctrl+V), or right-click"
_DEFAULT_SINGLE_HINT = "Drag and drop image here, paste (Ctrl+V), or right-click"
_DEFAULT_MULTI_HINT = "Drag and drop images here, paste (Ctrl+V), or right-click"
