...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_finance_dashboard), QCoreApplication.translate("MainWindow", u"Quick", None))
        ...
        self.label_yesterday_expense.setText(QCoreApplication.translate("MainWindow", u"0.0\u2080\u20bd", None))
        ...
        self.comboBox_filter_type.setItemText(2, QCoreApplication.translate("MainWindow", u"Income", None))
        ...
        self.label_subdivision.setText(QCoreApplication.translate("MainWindow", u"Subdivision:", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_categories), QCoreApplication.translate("MainWindow", u"Categories And Currencies", None))
        ...
        self.pushButton_calculate_exchange.setText(QCoreApplication.translate("MainWindow", u"Calculate To By Rate", None))
        self.label_exchange_fee.setText(QCoreApplication.translate("MainWindow", u"Fee:", None))
        self.pushButton_calculate_fee.setText(QCoreApplication.translate("MainWindow", u"Calculate Fee", None))
        ...
        self.pushButton_rates_refresh.setText(QCoreApplication.translate("MainWindow", u"Refresh Table", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Delete the last", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"days", None))
        self.pushButton_rates_delete.setText(QCoreApplication.translate("MainWindow", u"Delete", None))
        self.label_exchange_item_update.setText(QCoreApplication.translate("MainWindow", u"For", None))
        self.dateEdit_exchange_item_update.setDisplayFormat(QCoreApplication.translate("MainWindow", u"yyyy-MM-dd", None))
        self.label_exchange_item_update_2.setText(QCoreApplication.translate("MainWindow", u"new rate", None))
        self.pushButton_exchange_item_update.setText(QCoreApplication.translate("MainWindow", u"Update Rate", None))
        self.groupBox_filter_2.setTitle(QCoreApplication.translate("MainWindow", u"Filter For Table", None))
        self.label_filter_currency_2.setText(QCoreApplication.translate("MainWindow", u"Currency:", None))
        self.label_filter_date_2.setText(QCoreApplication.translate("MainWindow", u"Date:", None))
        self.dateEdit_filter_exchange_rates_from.setDisplayFormat(QCoreApplication.translate("MainWindow", u"yyyy-MM-dd", None))
        self.label_filter_to_2.setText(QCoreApplication.translate("MainWindow", u"to", None))
        self.dateEdit_filter_exchange_rates_to.setDisplayFormat(QCoreApplication.translate("MainWindow", u"yyyy-MM-dd", None))
        self.pushButton_filter_exchange_rates_clear.setText(QCoreApplication.translate("MainWindow", u"Clear Filter", None))
        self.pushButton_filter_exchange_rates_apply.setText(QCoreApplication.translate("MainWindow", u"Apply Filter", None))
        self.label_exchange_rates_currency.setText(QCoreApplication.translate("MainWindow", u"Currency", None))
        self.label_exchange_rates_from.setText(QCoreApplication.translate("MainWindow", u"From:", None))
        self.dateEdit_exchange_rates_from.setDisplayFormat(QCoreApplication.translate("MainWindow", u"yyyy-MM-dd", None))
        self.label_exchange_rates_to.setText(QCoreApplication.translate("MainWindow", u"To:", None))
        self.dateEdit_exchange_rates_to.setDisplayFormat(QCoreApplication.translate("MainWindow", u"yyyy-MM-dd", None))
        self.pushButton_exchange_rates_last_month.setText(QCoreApplication.translate("MainWindow", u"Last Month", None))
        self.pushButton_exchange_rates_last_year.setText(QCoreApplication.translate("MainWindow", u"Last Year", None))
        self.pushButton_exchange_rates_all_time.setText(QCoreApplication.translate("MainWindow", u"All Time", None))
        ...
        self.pushButton_select_only_expense.setText(QCoreApplication.translate("MainWindow", u"Select only Expense", None))
        self.pushButton_select_only_income.setText(QCoreApplication.translate("MainWindow", u"Select only Income", None))
    ...
    def setupUi(self, MainWindow):
        ...
        self.tab_finance_dashboard = QWidget()
        self.tab_finance_dashboard.setObjectName(u"tab_finance_dashboard")
        self.verticalLayout_finance_dashboard = QVBoxLayout(self.tab_finance_dashboard)
        self.verticalLayout_finance_dashboard.setObjectName(u"verticalLayout_finance_dashboard")
        self.tabWidget.addTab(self.tab_finance_dashboard, "")
...
"                                          }")
        ...
        self.dateEdit.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
...
"                                      }")
        ...
        self.groupBox_yesterday_expense.setObjectName(u"groupBox_yesterday_expense")
        ...
        self.verticalLayout_5.addWidget(self.groupBox_yesterday_expense)
...
"                                }")
        ...
        self.widget_transactions = QWidget(self.splitter)
        self.widget_transactions.setObjectName(u"widget_transactions")
        self.verticalLayout_transactions = QVBoxLayout(self.widget_transactions)
        self.verticalLayout_transactions.setSpacing(4)
        self.verticalLayout_transactions.setObjectName(u"verticalLayout_transactions")
        self.verticalLayout_transactions.setContentsMargins(0, 0, 0, 0)
        ...
        self.tableView_transactions = QTableView(self.widget_transactions)
        self.tableView_transactions.setObjectName(u"tableView_transactions")

        self.verticalLayout_transactions.addWidget(self.tableView_transactions)

        self.splitter.addWidget(self.widget_transactions)
        ...
        self.label_balance_account_details.setObjectName(u"label_balance_account_details")
        ...
        self.pushButton_balance_check.setObjectName(u"pushButton_balance_check")
...
"                                      }")
        ...
        self.frame_currencies = QFrame(self.splitter_3)
        ...
        self.splitter_3.addWidget(self.frame_currencies)
        self.tableView_currencies = QTableView(self.splitter_3)
        self.tableView_currencies.setObjectName(u"tableView_currencies")
        self.splitter_3.addWidget(self.tableView_currencies)
        ...
        self.pushButton_calculate_fee.setObjectName(u"pushButton_calculate_fee")
        ...
        self.dateEdit_exchange.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
...
"                                    }")
        ...
        self.splitter_4.addWidget(self.frame_exchange)
        self.tableView_exchange = QTableView(self.splitter_4)
        self.tableView_exchange.setObjectName(u"tableView_exchange")
        self.splitter_4.addWidget(self.tableView_exchange)

        self.horizontalLayout_10.addWidget(self.splitter_4)
        ...
        self.horizontalLayout_28 = QHBoxLayout(self.tab_exchange_rates)
...
"                                            }")
        ...
        self.label_exchange_item_update.setObjectName(u"label_exchange_item_update")
        ...
        self.comboBox_exchange_item_update.setObjectName(u"comboBox_exchange_item_update")
        ...
        self.dateEdit_exchange_item_update.setObjectName(u"dateEdit_exchange_item_update")
        ...
        self.horizontalLayout_currency_filter_2.setObjectName(u"horizontalLayout_currency_filter_2")
        self.label_filter_currency_2 = QLabel(self.groupBox_filter_2)
        self.label_filter_currency_2.setObjectName(u"label_filter_currency_2")
        ...
        self.label_filter_date_2.setObjectName(u"label_filter_date_2")
        ...
        self.label_filter_to_2.setObjectName(u"label_filter_to_2")
        self.label_filter_to_2.setMinimumSize(QSize(61, 0))
        self.label_filter_to_2.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.pushButton_filter_exchange_rates_clear.setObjectName(u"pushButton_filter_exchange_rates_clear")
        ...
        self.pushButton_filter_exchange_rates_apply.setObjectName(u"pushButton_filter_exchange_rates_apply")
        ...
        self.splitter_6.addWidget(self.frame_rates)
        self.widget_exchange_rates_right = QWidget(self.splitter_6)
        self.widget_exchange_rates_right.setObjectName(u"widget_exchange_rates_right")
        ...
        self.frame_exchange_rates_controls.setObjectName(u"frame_exchange_rates_controls")
        ...
        self.horizontalLayout_exchange_rates_controls.setObjectName(u"horizontalLayout_exchange_rates_controls")
        self.label_exchange_rates_currency = QLabel(self.frame_exchange_rates_controls)
        self.label_exchange_rates_currency.setObjectName(u"label_exchange_rates_currency")
        ...
        self.comboBox_exchange_rates_currency.setObjectName(u"comboBox_exchange_rates_currency")
        ...
        self.label_exchange_rates_from.setObjectName(u"label_exchange_rates_from")
        ...
        self.dateEdit_exchange_rates_from.setObjectName(u"dateEdit_exchange_rates_from")
        ...
        self.label_exchange_rates_to.setObjectName(u"label_exchange_rates_to")
        ...
        self.dateEdit_exchange_rates_to.setObjectName(u"dateEdit_exchange_rates_to")
        ...
        self.pushButton_exchange_rates_last_month.setObjectName(u"pushButton_exchange_rates_last_month")
        ...
        self.pushButton_exchange_rates_last_year.setObjectName(u"pushButton_exchange_rates_last_year")
        ...
        self.pushButton_exchange_rates_all_time.setObjectName(u"pushButton_exchange_rates_all_time")
        ...
        self.scrollArea_xchange_rates.setObjectName(u"scrollArea_xchange_rates")
        ...
        self.scrollAreaWidgetContents_food_stats.setGeometry(QRect(0, 0, 712, 679))
        ...
        self.splitter_6.addWidget(self.widget_exchange_rates_right)
        ...
        self.frame_accounts_2.setObjectName(u"frame_accounts_2")
        ...
        self.radioButton_type_of_chart_balance.setObjectName(u"radioButton_type_of_chart_balance")
        ...
        self.radioButton_expense_and_income_compare_last_years.setObjectName(u"radioButton_expense_and_income_compare_last_years")
        ...
        self.radioButton_type_of_chart_category.setObjectName(u"radioButton_type_of_chart_category")
        ...
        self.pushButton_select_deselect_all.setObjectName(u"pushButton_select_deselect_all")
        ...
        self.pushButton_select_only_expense.setObjectName(u"pushButton_select_only_expense")
        ...
        self.pushButton_select_only_income.setObjectName(u"pushButton_select_only_income")
        ...
        self.checkBox_chart_show_labels.setObjectName(u"checkBox_chart_show_labels")
        ...
        self.scrollAreaWidgetContents_charts.setGeometry(QRect(0, 0, 919, 643))
...
"                                }")
        ...
        self.tableView_reports = QTableView(self.splitter_5)
        self.tableView_reports.setObjectName(u"tableView_reports")
        self.splitter_5.addWidget(self.tableView_reports)
