...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_yesterday_expense.setTitle(QCoreApplication.translate("MainWindow", "Yesterday's Expenses", None))
        self.label_yesterday_expense.setText(QCoreApplication.translate("MainWindow", "0.00\u20bd", None))
        ...
        self.tabWidget.setTabText(
            ...
            QCoreApplication.translate("MainWindow", "Categories And Currencies", None),
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_currencies),
        ...
        self.pushButton_select_only_income.setText(QCoreApplication.translate("MainWindow", "Select only Income", None))
