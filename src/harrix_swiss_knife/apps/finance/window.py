...
"                                            }")
        ...
        self.horizontalLayout_chart_categories_select_all.setObjectName(u"horizontalLayout_chart_categories_select_all")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_select_all.setToolTip(QCoreApplication.translate("MainWindow", u"Select all categories", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_select_deselect_all.setText(QCoreApplication.translate("MainWindow", u"Deselect all", None))
#if QT_CONFIG(tooltip)
        self.pushButton_select_deselect_all.setToolTip(QCoreApplication.translate("MainWindow", u"Deselect all categories", None))
#endif // QT_CONFIG(tooltip)
