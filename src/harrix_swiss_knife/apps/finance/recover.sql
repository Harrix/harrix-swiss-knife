...
INSERT INTO currencies (code, name, symbol, subdivision, ticker) VALUES ('RUB', 'Russian Ruble', '₽', 100, 'RUBUSD=X');
INSERT INTO currencies (code, name, symbol, subdivision, ticker) VALUES ('USD', 'US Dollar', '$', 100, NULL);
INSERT INTO currencies (code, name, symbol, subdivision, ticker) VALUES ('EUR', 'Euro', '€', 100, 'EURUSD=X');
INSERT INTO currencies (code, name, symbol, subdivision, ticker) VALUES ('CNY', 'Chinese Yuan', '¥', 100, 'CNYUSD=X');
INSERT INTO currencies (code, name, symbol, subdivision, ticker) VALUES ('VND', 'Vietnamese Dong', '₫', 1, 'VNDUSD=X');
INSERT INTO currencies (code, name, symbol, subdivision, ticker) VALUES ('TRY', 'Turkish Lira', '₺', 100, 'TRYUSD=X');
