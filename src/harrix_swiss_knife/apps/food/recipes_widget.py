...
class RecipesWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.spin_ingredient_weight.setFont(standard_bold_font)
        ...
        self.spin_ingredient_calories.setFont(standard_bold_font)
        ...
        self.button_add_ingredient.setFont(standard_bold_font)
        ...
        self.label_recipe_totals.setFont(totals_font)
