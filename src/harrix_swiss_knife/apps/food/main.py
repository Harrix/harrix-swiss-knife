...
_MACROS_FAILED_PREVIEW_LIMIT = 8
_STATS_DAY_DATE_COLUMN = 0
_STATS_DAY_CALORIES_COLUMN = 1
_STATS_DAY_PROTEIN_COLUMN = 2
_STATS_DAY_FAT_COLUMN = 3
_STATS_DAY_CARB_COLUMN = 4
_STATS_DAY_KCAL_COLUMN = 5
_STATS_DAY_STATUS_COLUMN = 6
_STATS_DAY_NOTES_COLUMN = 7
_STATS_DAY_HEADERS = ["Date", "Calories", "P", "F", "C", "kcal", "Status", "Notes"]
...
def _is_food_ai_drop_path(file_path: str) -> bool:
    """Accept image drops for AI and food-log transfer JSON for import preview."""
    return is_image_file_path(file_path) or is_food_log_transfer_path(file_path)
