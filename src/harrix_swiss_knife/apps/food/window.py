...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_food_dashboard), QCoreApplication.translate("MainWindow", u"Dashboard", None))
    ...
    def setupUi(self, MainWindow):
        ...
        self.tab_food_dashboard = QWidget()
        self.tab_food_dashboard.setObjectName(u"tab_food_dashboard")
        self.verticalLayout_food_dashboard = QVBoxLayout(self.tab_food_dashboard)
        self.verticalLayout_food_dashboard.setObjectName(u"verticalLayout_food_dashboard")
        self.tabWidget.addTab(self.tab_food_dashboard, "")
