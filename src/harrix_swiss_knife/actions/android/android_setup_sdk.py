...
from harrix_swiss_knife.actions.common.android_gradle import (
    ...
    default_portable_jdk_home,
    gradle_env,
    is_android_studio_installed,
    java_home_is_version_17,
    resolve_java17_home,
...
from harrix_swiss_knife.actions.common.github_https import github_download_headers
...
class OnAndroidSetupSdk(ActionBase):
    r"""Install JDK 17 and Android SDK packages for building the Android module.
