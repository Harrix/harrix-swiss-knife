...
from harrix_swiss_knife.actions.markdown.new_markdown_commands import BuiltinMarkdownCommandsMixin
...
class OnNewMarkdown(BuiltinMarkdownCommandsMixin, ActionBase):
    """Create new Markdown files using various templates and formats.
