...
class on_diary_new(action_base.ActionBase): # ⚠️ TODO
    icon = "📖"
...
class on_diary_new_dream(action_base.ActionBase): # ⚠️ TODO
    icon = "💤"
...
class on_diary_new_with_images(action_base.ActionBase): # ⚠️ TODO
    icon = "📚"
...
class on_download_and_replace_images(action_base.ActionBase): # ⚠️ TODO
    icon = "📥"
...
class on_download_and_replace_images_folder(action_base.ActionBase): # ⚠️ TODO
    icon = "📥"
...
class on_format_yaml(action_base.ActionBase): # ⚠️ TODO
    icon = "✨"
    title = "Format YAML"
    is_show_output = True
...
class on_generate_author_book(action_base.ActionBase): # ⚠️ TODO
    icon = "❞"
...
class on_generate_image_captions(action_base.ActionBase): # ⚠️ TODO
    icon = "🌄"
...
class on_generate_image_captions_folder(action_base.ActionBase): # ⚠️ TODO
    icon = "🌄"
...
class on_generate_toc(action_base.ActionBase): # ⚠️ TODO
    icon = "📑"
...
class on_generate_toc_folder(action_base.ActionBase): # ⚠️ TODO
    icon = "📑"
...
class on_get_list_movies_books(action_base.ActionBase): # ⚠️ TODO
    icon = "🎬"
...
class on_increase_heading_level_content(action_base.ActionBase): # ⚠️ TODO
    icon = "👉"
...
class on_new_article(action_base.ActionBase): # ⚠️ TODO
    icon = "✍️"
    title = "New article"
...
class on_new_note_dialog(action_base.ActionBase): # ⚠️ TODO
    icon = "📓"
    title = "New note"
...
class on_new_note_dialog_with_images(action_base.ActionBase): # ⚠️ TODO
    icon = "📓"
...
class on_prettier_folder(action_base.ActionBase): # ⚠️ TODO
    icon = "✨"
    title = "Prettier in …"
    is_show_output = True
...
class on_sort_sections(action_base.ActionBase): # ⚠️ TODO
    icon = "📶"
...
class on_sort_sections_folder(action_base.ActionBase): # ⚠️ TODO
    icon = "📶"
...
class on_combine_markdown_files(action_base.ActionBase): # ⚠️ TODO
    icon = "🔗"
