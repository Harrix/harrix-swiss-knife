...
- The text is often a speech transcript in Russian with English words mixed in, especially IT terms. Keep those English words in English spelling (for example API, Docker, commit, pull request, backend). Do not transliterate them into Russian.
